        ...
        <div class="main">
            ...
            <div style="margin-top: 4rem;">
                <div class="list" v-for="(item,index) in items">
                    ...
                    <div class="text">
                        <h2>{{item.title}}<span>{{item.categories[0].name}}</span></h2>
...
<style scoped>
    ...
    .main{margin:45px 0;overflow: hidden;}
     ...
     .ens{float: left;line-height: 2.5rem;font-size: 1rem;color: #3b3b3b;}
     ...
     .che{float: right;padding-right:1.5rem;line-height: 2.5rem;
         background-image: url("../assets/fonts/icon_che.png");background-repeat: no-repeat;background-position:right center;background-size: 1rem;}
     ...
     .list .img{width:15%;}
    .list .img img{width:90%;margin:0.4rem 0;}
     .list .text{width:55%;box-sizing: border-box;padding:0.5rem 0;}
     .list .text h2{height:2rem;line-height:2rem;font-size: 1rem;color: #3b3b3b;}
    ...
    .list .text p{height: 2rem;line-height: 2rem;font-size: 1rem;color: #b3b3b3;}
     .list .play{width: 10%;padding:1rem 0;background-image: url("../assets/fonts/icon_sp1.png");background-repeat: no-repeat;
         background-position: center;background-size:2rem;border-right:1px solid #e6e6e6;}
     .list .delete{width: 10%;background-image: url("../assets/fonts/icon_del.png");background-repeat: no-repeat;background-position: center;background-size: 1.5rem;}
</style>